...
from app.schemas import CreatePenjualan
...
@router.get("/{penjualan_id}", dependencies=[Depends(login_required)])
...
@router.post("/{penjualan_id}/accept", dependencies=[Depends(admin_only)])
